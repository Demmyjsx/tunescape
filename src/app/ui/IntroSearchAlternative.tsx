...
export default function IntroSearchAlternative({ searchParams }: IntroSearchProps) {
      ...
      <div className="bg-hero mx-auto h-screen">
        <div className="space-y-6">
          ...
          <div className="flex justify-center mt-10">
            <div className="flex w-1/2 md:w-full max-w-lg">
              ...
              <button
                ...
                disabled={loading}
                className="px-4 py-2 bg-pink-600 hover:bg-pink-700 disabled:bg-pink-400 text-white rounded-r-lg flex items-center justify-center"
              >
                {loading ? (
          ...
          <ul className="space-y-4 lg:w-dvh mx-10 md:mx-auto">
            {loading && (
              <li className="text-white text-center mt-4">Searching...</li>
            )}
            {error && (
              <li className="text-red-400 text-center mt-4">{error}</li>
            )}
